...
public class Test3 {
    public static void main(String[] args) {
        ...
        // 배열 생성
        {
            int[] intArray = new int[5];    // 길이가 5인 int 배열 객체가 heap에 생성, 각각의 값은 int의 기본값인 0으로 초기화
            int[] intArray2 = {1,2,3,4,5};  // 길이가 5인 int 배열 객체가 heap에 생성되고, 각각의 값이 할당
            int a = 10; int b = 20;
...
//            System.out.println(Arrays.toString(intArray4));
        ...
        // String[]
        {
            ...
            System.out.println(strArray[2].length());
        }
