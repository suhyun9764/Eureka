...
<script>
    ...
    window.onload = function(){
        ...
        document.querySelector("#btnBoardUpdateForm").onclick = function(){
            // 상세 모달의 data-boardId 을 글 수정 모달의 data-boardId 복사
            ...
            // 수정 모달 show 상세 모달 hide ( data-dismiss 처리도 자동으로 close )
...
//              console.log(regDt);
    ...
    function addPagination(){
        makePaginationHtml(List_ROW_COUNT, PAGE_LINK_COUNT,CURRENT_PAGE_INDEX,TOTAL_LIST_COUNT,"pagenationwrapper")
    }
